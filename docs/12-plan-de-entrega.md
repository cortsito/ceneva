...
**la siguiente vertical planificada es `cs-7-1-organizacion-economica` de ciencias sociales.** conserva el patrón de tres tareas secuenciales en `docs/tasks/2026-09-18-task_etapa-5-cs-7-1-*.md`: nueve lecciones con ids reservados, un banco validado de cuarenta y cinco preguntas y su registro e integración visible como séptima entrada de `available_units`. se eligió sobre las dos unidades de ocho temas porque la diferencia de una lección mantiene el lote pequeño, pero sus conceptos son más estables y coherentes, todos sus prerrequisitos quedan dentro de la unidad y una muestra oficial aplica directamente a `7.1.1` en la página impresa 42. los reactivos usan situaciones originales y autosuficientes, sin depender de estadísticas, programas o instituciones actuales. al completar esta vertical, las siete áreas tendrán una unidad navegable; antes de expandir diagnóstico, simulacro, repaso global o dashboard fuera de pensamiento matemático, se realizará una auditoría de alcance de etapa 5.
