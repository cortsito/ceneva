...
el siguiente trabajo es editorial: continuar los pasos 3–5 de `docs/tasks/2026-09-10-report_curriculum-mapping-guide.md` para las cinco áreas restantes, de forma independiente por unidad, más verificar el preview de vercel si el repositorio ya está conectado.
