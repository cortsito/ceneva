...
**la siguiente vertical planificada es `lc-6-1-estrategias-de-comprension-lectora` de lengua y comunicación.** conserva el patrón de tres tareas secuenciales en `docs/tasks/2026-09-18-task_etapa-5-lc-6-1-*.md`: cuatro lecciones con ids reservados, un banco validado de veinte preguntas y su registro e integración visible como sexta entrada de `available_units`. se eligió porque es la unidad autocontenida más pequeña del área: sus cuatro temas tienen una lección cada uno y ningún prerrequisito. las muestras de español de la guía en las páginas impresas 37 y 38 corresponden a fuentes de información, puntuación y coherencia de `6.3`, por lo que calibran el formato de tres opciones y las formas de relación u ordenamiento, pero no amplían el contenido de `6.1`. después se repetirá el mismo patrón para una primera unidad de ciencias sociales, la última área necesaria para cubrir el mvp.
